...
const mutilPath = (process.env.MUTIL_PATH || '').split('/').filter(Boolean);
...
module.exports = function (webpackEnv) {
  ...
  const isEnvProductionAnalyzer =
    isEnvProduction && process.argv.includes('--analyzer');
  ...
  return {
    ...
    output: {
      ...
      filename: isEnvProduction
        ...
        : isEnvDevelopment && 'static/js/bundle.js?v=[hash:8]',
      // TODO: remove this when upgrading to webpack 5
      futureEmitAssets: true,
      // There are also additional JS chunk files if you use code splitting.
      chunkFilename: isEnvProduction
        ? 'static/js/[name].chunk.js?v=[contenthash:8]'
        : isEnvDevelopment && 'static/js/[name].chunk.js?v=[contenthash:8]',
    ...
    plugins: [
      ...
      new webpack.DefinePlugin({
        ...env.stringified,
        'process.env.PWD': JSON.stringify(paths.root)
      }),
      ...
      isEnvProductionAnalyzer && new BundleAnalyzerPlugin(),
      ...
      new MonacoWebpackPlugin(['python'])
    ].filter(Boolean),
